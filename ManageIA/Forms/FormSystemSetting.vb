...
Public Class FormSystemSetting
    ...
    Private Sub btnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEdit.Click
        If DataGridVariable.SelectedRows.Count > 0 Then
            ...
            Dim bSessionVFlag As Boolean = False
            Dim pFilter As IQueryFilter = New QueryFilter
            pFilter.WhereClause = "NAME='" & pForm.TextName.Text & "'"
            pFilter.SubFields = "SESSION_VARIABLE"
            Dim pCursor As ICursor = m_table.Search(pFilter, False)
            Dim pRow As IRow = pCursor.NextRow
            If MapUtil.GetRowValue(pRow, "SESSION_VARIABLE") = "Y" Then
                bSessionVFlag = True
            Else
                bSessionVFlag = False
            End If
