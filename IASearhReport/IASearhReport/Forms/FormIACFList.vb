...
Public Class FormIACFList
    ...
    Private Sub OK_Button_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OK_Button.Click
        ...
        '**is dbnull check added by amanda
        If IsDBNull(DataGridIACF.SelectedRows.Item(0).Cells(2).Value) Then
            '** if/else structure w/ msgbox added by amanda
            MsgBox("There was an error with the IACF record.  Please select a record with an effective date")
        Else
            MsgBox("Warning! You are switching to a historical view of the data." & vbCrLf & _
                          "To reset to the transactional version deselect the 'IA Charge History' tool", _
                          MsgBoxStyle.Information, Title:="IA Search Report")
